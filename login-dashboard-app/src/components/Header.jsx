...
const Header = () => {
  ...
  return (
    <div className="p-0 mx-6 mt-3  ">

      <div className="bg-white p-4 flex flex-col  rounded-xl shadow md:flex-row md:items-center md:justify-between rounded-xl  gap-4 border-b-0 shadow-none ">
